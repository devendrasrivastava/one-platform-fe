...
export default function Header() {
  ...
  return (
    <div>
      ...
      <Navbar collapseOnSelect expand="lg" variant="dark" style={{ fontSize: "20px", color: "white", background: "#009FAC" }}>
        <Container className='Containers ' >
          <Navbar.Brand href="/" data-testid="herounit" >NatWest One</Navbar.Brand>

          {/* <a class="navbar-brand img-fluid" id='nwlogo' href="/"><img src="./assets/nwlogo.png" alt=""/></a> */}
